...
Usage:
  vault-backup [-i IP:PORT] [-t TOKEN] [--aclbackup] [--aclbackupfile ACLBACKUPFILE] [--restore] <filename>
  vault-backup -h | --help
  vault-backup --version
...
Options:
  ...
  -r, --restore                      Activate restore mode`
	...
	arguments, _ := docopt.Parse(usage, nil, true, "vault-backup 1.0", false)
